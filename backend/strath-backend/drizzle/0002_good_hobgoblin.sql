...
--> statement-breakpoint
ALTER TABLE "profiles" ALTER COLUMN "embedding" SET DATA TYPE vector(3072);--> statement-breakpoint
ALTER TABLE "profiles" ADD COLUMN "personality_answers" jsonb;--> statement-breakpoint
ALTER TABLE "profiles" ADD COLUMN "lifestyle_answers" jsonb;--> statement-breakpoint
